package mod.gottsch.forge.gmm.core.client.model;// Made with Blockbench 4.9.4
...
/**
 * Ported verbatim (geometry unchanged) from Treasure2's {@code VanillaChestMimicModel}.
 *
 * @author Mark Gottschling on 7/8/2026 -- ported from Treasure2's VanillaChestMimicModel
 */
public class VanillaChestMimicModel<T extends VanillaChestMimic> extends MimicModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(GMM.MOD_ID, "vanilla_chest_mimic"), "main");
	...
	public VanillaChestMimicModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition eye1 = lid.addOrReplaceChild("eye1", CubeListBuilder.create().texOffs(43, 25).addBox(-2.5F, 0.0F, -2.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(4.5F, -2.1F, -12.1F));
		PartDefinition eye3 = lid.addOrReplaceChild("eye3", CubeListBuilder.create().texOffs(0, 25).addBox(-2.5F, 0.0F, -2.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(1.5F, -3.1F, -12.1F));
		PartDefinition eye2 = lid.addOrReplaceChild("eye2", CubeListBuilder.create().texOffs(0, 30).addBox(-2.5F, 0.0F, -2.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.5F, -2.1F, -12.1F));
		PartDefinition skin1 = lid.addOrReplaceChild("skin1", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -4.0F, -2.5F, 0.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.0F, 2.0F, -4.5F, 0.5236F, 0.0F, 0.0F));
		...
		PartDefinition bottomHinge1 = base.addOrReplaceChild("bottomHinge1", CubeListBuilder.create(), PartPose.offset(3.0F, 0.0F, 0.0F));
		PartDefinition bottomHinge2 = base.addOrReplaceChild("bottomHinge2", CubeListBuilder.create(), PartPose.offset(-3.0F, 1.0F, 0.0F));
	...
	public void hiddenAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		super.hiddenAnim(entity, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
		latch.xRot = 0F;
		eye1.xRot = 0F;
		eye2.xRot = 0F;
		eye3.xRot = 0F;
	...
	public void openAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float timeSlice) {
		...
		latch.xRot = timeSlice * 2.4870942F;
